...
あなたの過去投稿を AI が解析してステータスと気質ジョブで可視化する Web クライアント。気質はそのままオリジナルの TCG カードになって Bluesky にシェアできる。AI 推論はすべて端末内で動くので、投稿内容が外部に送られない。
...
### 気質診断 RPG
あなたの Bluesky の過去投稿を AI が解析して、ステータス値と気質ジョブで可視化する。投稿し続けることでステータスは伸び、クエストをこなして成長していく。

<p align="center">
  <img src="docs/hero-radar.png" alt="気質診断のレーダーチャート (攻/守/速/知/運)" width="480" />
</p>
