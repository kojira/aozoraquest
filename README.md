...
- キーワード能力 (飛行 / トランプル / 接死 / 二段攻撃 等の MTG 風 13 種、SNS メタファ付き)
- パワー / タフネス
- そして毎回違う**ぶっ飛んだ効果** — 「対象アカウントのフォロワーを全員ゼロにする」「タップして起動: 任意のハッシュタグをトレンド 1 位に永久固定する」「あなたの公式マークを破棄する: 任意の 5 アカウントに公式マークを付与する」など
