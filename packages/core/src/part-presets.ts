...
const CASTLE_ART: TileArtRecord = {
  ...
  pixels:
    '',
};
...
const DUNGEON_ART: TileArtRecord = {
  ...
  pixels:
    '',
};
...
const VBRIDGE_ART: TileArtRecord = {
  ...
  pixels:
    '',
};
